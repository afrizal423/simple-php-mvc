...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/public/invoice.css">
                ...
                <div class="row">
                    <div class="col">
                        <!-- <a target="_blank" href="https://lobianijs.com">
                            ...
                            <h2 class="name">
                            <a target="_blank" href="https://afrizalmy.com">
                            Qantin UPN
                            </a>
                        </h2>
                    </div>
                    <div class="col company-details">
                        ...
                        <div>Jl. Rungkut Madya No.1, Gn. Anyar, Kec. Gn. Anyar, Kota SBY, Jawa Timur 60294</div>
                        <div>031031031</div>
                        <div>qantin@example.com</div>
                    </div>
                </div>
            </header>
            <main>
                <div class="row contacts">
                    <div class="col invoice-to">
                        <div class="text-gray-light">Pembayaran Kepada:</div>
                        <h2 class="to">John Doe</h2>
                        <div class="address">796 Silver Harbour, TX 79273, US</div>
                    </div>
                    <div class="col invoice-details">
                        <h1 class="invoice-id">Pembayaran #3-2-1</h1>
                        <div class="date">Tanggal Pesanan: 01/10/2018</div>
                    </div>
                </div>
